...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Titulo.setText("Gestão Acadêmica");
    ...
    // Instancia e abre a janela de cadastro 
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new CadastroForm().setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    // Instancia e abre a janela de seleção para deletar dados
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new DeleteForm().setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    // Instancia e abre a janela de visualização dos dados da tabela
